...
A beginner-friendly JavaScript mini project that generates a random CSS gradient with a single click.  
Each gradient updates the preview box and displays the full CSS `linear-gradient()` value.
