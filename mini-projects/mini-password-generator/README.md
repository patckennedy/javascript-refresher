...
A simple JavaScript mini project that generates a random password based on user-selected options.  
Built as part of my **JavaScript Refresher** series to practice DOM manipulation, events, and basic logic.
...
└─ script.js # Password generation logi
